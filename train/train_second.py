...
df4 = df4.fillna(0)
# print df4
# print df4[(df4['result']==1) & (df4['user_id']==200014.0)  & (df4['sku_id']==125188)]
# print df4[(df4['user_id']==200014.0)  & (df4['sku_id']==125188) &(df4['4']==1) ]
df4.to_csv('trainresult',index=False)
